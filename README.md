...
This project goal is to develop 2 machine learning models for 2 of the most common home exercises **(Bicep Curl and Plank)** which each model can detect any form of incorrect movement while a person is performing a correspond exercise.
